<?php
    ...
    const CONSTRAINT_USERNAME_DESCRIPTION = "Le pseudo doit contenir entre 3 et 20 caractères, "
                                            . "les caractères suivants sont autorisés : <br>"
                                            . "- Lettres majuscules et minuscules <br>"
                                            . "- Chiffres <br>"
                                            . "- Les caractères spéciaux suivants : . - _<br>";

    const CONSTRAINT_PASSWORD_REGEX = '/^(?=.*[A-Z])(?=.*\d)(?=.*[\W_]).{12,}$/';
    const CONSTRAINT_PASSWORD_DESCRIPTION = "Le mot de passe doit contenir au moins 12 caractères, "
